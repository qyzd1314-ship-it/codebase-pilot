...
import com.yupi.yuaiagent.eval.dto.EvalCaseDto;
import com.yupi.yuaiagent.eval.dto.EvalCaseResultDto;
import com.yupi.yuaiagent.eval.dto.EvalReportDto;
import com.yupi.yuaiagent.eval.dto.EvalRetrievedChunkDto;
import com.yupi.yuaiagent.eval.dto.EvalStrategy;
import com.yupi.yuaiagent.eval.dto.EvalStrategyReportDto;
...
import com.yupi.yuaiagent.task.agent.impl.DiagnosisAgent;
import com.yupi.yuaiagent.task.agent.impl.PatchAgent;
...
public class EvalRunnerService {
    ...
    private AgentResult runReviewer(EvalCaseDto evalCase,
        ...
        AgentContext context = AgentContext.builder()
                ...
                .previousSteps(List.of(
                        ...
                        buildAgentStepSummary(3L, 3, "鍒嗘瀽鍙兘鍘熷洜", "DiagnosisAgent", diagnosisResult)
                ))
                .evidenceRefs(evidenceRefs)
    ...
    private static final class EvalLlmServiceCollector implements LlmService {
        ...
        @Override
        public com.yupi.yuaiagent.llm.dto.LlmResponse chat(LlmRequest request) {
